...
UNIT_SRC="${REPO_ROOT}/nodes/rt-radio/systemd/rt-radio-presence.service"
UNIT_DST="/etc/systemd/system/rt-radio-presence.service"

UNITS=("rt-radio-presence.service")
