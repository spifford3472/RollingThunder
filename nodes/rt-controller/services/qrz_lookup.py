...
def normalize_qrz_result(payload: Mapping[str, Any] | None) -> dict[str, str]:
    ...
    out = {
        ...
        "country": _to_str(payload.get("country")),
        "land": _to_str(payload.get("land")),
        "county": _to_str(payload.get("county")),
        "ccode": _to_str(payload.get("ccode")),
        "dxcc": _to_str(payload.get("dxcc")),
        "cqzone": _to_str(payload.get("cqzone")),
        "ituzone": _to_str(payload.get("ituzone")),
        "geoloc": _to_str(payload.get("geoloc")),        
