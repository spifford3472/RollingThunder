...
class QRZClient:
    ...
    def _query_once(self, call: str) -> Mapping[str, Any] | None:
        ...
        return {
            ...
            "land": _first_text(callsign, "qrz:land"),
            "county": _first_text(callsign, "qrz:county"),
            "ccode": _first_text(callsign, "qrz:ccode"),
            "dxcc": _first_text(callsign, "qrz:dxcc"),
            "cqzone": _first_text(callsign, "qrz:cqzone"),
            "ituzone": _first_text(callsign, "qrz:ituzone"),
            "geoloc": _first_text(callsign, "qrz:geoloc"),
