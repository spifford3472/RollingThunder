...
Services do not start other services directly

Pages do not execute logic

Panels do not contain business rules

All control paths emit intents

Always-on services are minimal

External systems are integrated, not absorbed

Behavior must be explainable from JSON alone
