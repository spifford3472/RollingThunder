...
Every panel referenced by any page exists in config/panels/

Every service referenced by any page exists in config/app.json

order is unique per page and is an integer

layout.middle is 1–3 columns (recommended maximum)
...
Create a new panel file under config/panels/ (optional)

Create a new page file under config/pages/

Reference existing panel IDs in the page layout

List required/optional services by service ID
